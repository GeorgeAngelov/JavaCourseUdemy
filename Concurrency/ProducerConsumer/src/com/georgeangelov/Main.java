...
import static com.georgeangelov.Main.EOF;
import static com.georgeangelov.ThreadColor.*;
...
//        ReentrantLock bufferLock = new ReentrantLock();
        ...
        Future<String> future = executorService.submit(new Callable<String>() {
            ...
            public String call() throws Exception {
                System.out.println(ANSI_BLUE + "I`m being printed from the Callable class");
