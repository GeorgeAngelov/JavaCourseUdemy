...
//             FileChannel bigChannel = binFile.getChannel()){
//
//	        ByteBuffer buffer = ByteBuffer.allocate(100);
//
//
//            byte[] ouputBytes = "Hello World!".getBytes();
//            buffer.put(ouputBytes);
//            long int1Pos = ouputBytes.length;
//            buffer.putInt(245);
...
//            System.out.println("NumTransfered = " + numTransfered);
//
//            channel.close();
//            ra.close();
//            copyChannel.close();
