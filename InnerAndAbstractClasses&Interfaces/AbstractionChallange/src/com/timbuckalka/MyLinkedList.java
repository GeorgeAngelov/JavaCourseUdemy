        ...
        while (currentItem!=null){
            ...
            if (comparison < 0){
                ...
                if (currentItem.next()!=null){
                    ...
                    currentItem.setNext(newItem).setPrevious(newItem.setPrevious(currentItem));
                    return true;
                }
            }else if (comparison > 0){
                // newItem is less, insert before
                if (currentItem.previous() != null){
                    currentItem.previous().setNext(newItem).setPrevious(newItem.setPrevious(currentItem.previous()));
